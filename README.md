...
[linode.cloud.monitor_logs_destination](./docs/modules/monitor_logs_destination.md)|Manage logs destination that sevres as a sync point for logs data. It can only be accessed by account users with unrestricted access. |
