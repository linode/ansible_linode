...
spec = dict(
    ...
    order=SpecField(type=FieldType.string, description=['The order to list regions in.'],
               default='asc', choices=['desc', 'asc']),
    order_by=SpecField(type=FieldType.string, description=['The attribute to order regions by.']),
...
class Module(LinodeModuleBase):
    ...
    def exec_module(self, **kwargs: Any) -> Optional[dict]:
        ...
        self.results['regions'] = get_all_paginated(self.client, '/regions',
