...
import ansible_collections.linode.cloud.plugins.module_utils.doc_fragments.database_engine_list \
     as docs
...
class Module(LinodeModuleBase):
    ...
    def exec_module(self, **kwargs: Any) -> Optional[dict]:
        ...
        self.results['database_engines'] = get_all_paginated(self.client, '/databases/engines/',
