...
import ansible_collections.linode.cloud.plugins.module_utils.doc_fragments.instance_interface_firewall_list as docs
...
module = ListModule(
    ...
    result_docs_url="https://techdocs.akamai.com/linode-api/reference/get-linode-interface-firewalls",
