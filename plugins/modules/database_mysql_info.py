...
spec = dict(
    ...
    id=SpecField(type=FieldType.string, description=['The ID of the MySQL Database.']),
    label=SpecField(type=FieldType.string, description=['The label of the MySQL Database.']),
)
